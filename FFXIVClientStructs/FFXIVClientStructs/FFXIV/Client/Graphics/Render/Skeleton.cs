...
public unsafe struct Skeleton
{
    ...
    [FieldOffset(0x58)] public void**
        SKLBArray; // Client::System::Resource::Handle::SkeletonResourceHandle pointer array, size = PartialSkeletonCount

    // 60: unk
    [FieldOffset(0x68)] public PartialSkeleton* PartialSkeletons; // Client::Graphics::Animation::PartialSkeleton array, size = PartialSkeletonCount
